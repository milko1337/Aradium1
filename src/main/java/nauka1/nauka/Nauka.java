...
import nauka1.nauka.zbroje.comand.gold;
...
public final class Nauka extends JavaPlugin {
    ...
    private void registerarrmorEventListeners() {      //zbroje
        ...
        pm.registerEvents(new nauka1.nauka.zbroje.item.gold.goldarmorListener1(),this);
        pm.registerEvents(new nauka1.nauka.zbroje.item.gold.goldarmorListener2(),this);
        pm.registerEvents(new nauka1.nauka.zbroje.item.gold.goldarmorListener3(),this);
        pm.registerEvents(new nauka1.nauka.zbroje.item.gold.goldarmorListener4(),this);
    }
