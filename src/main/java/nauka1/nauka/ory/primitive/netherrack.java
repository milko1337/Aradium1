...
import static nauka1.nauka.imports.material.itemnetherrackMaterial;
import static nauka1.nauka.imports.permisions.permissionnetherrack;
...
public class netherrack {
    ...
    public static class netherrackRespawnTask extends BukkitRunnable implements Listener {
        ...
        public netherrackRespawnTask(World world, Location min, Location max, long interval) {
            this.world = world;
            this.min = min;
            this.max = max;
    ...
    public static class netherrackRegionCommand implements CommandExecutor, Listener {
        ...
        public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
            ...
            if (min != null && max != null) {
                ...
                BukkitRunnable task = new netherrack.netherrackRespawnTask(world, min, max, interval);
